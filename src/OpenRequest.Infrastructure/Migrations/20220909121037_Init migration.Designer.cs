...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenRequest.Core.Entities.Assignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OpenRequest.Core.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OpenRequest.Core.Entities.PostCategory", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OpenRequest.Core.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OpenRequest.Core.Entities.Assignment", b =>
                {
                    b.HasOne("OpenRequest.Core.Entities.Post", "Post")
                        .WithOne("Assignment")
                        .HasForeignKey("OpenRequest.Core.Entities.Assignment", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OpenRequest.Core.Entities.PostCategory", b =>
                {
                    b.HasOne("OpenRequest.Core.Entities.Category", "Category")
            ...
            modelBuilder.Entity("OpenRequest.Core.Entities.RefreshToken", b =>
                {
                    b.HasOne("OpenRequest.Core.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
